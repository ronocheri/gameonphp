...
$result = mysql_query("select Game.game_id,Game.game_date, Game.start_time, Game.game_location , Game_invitation.approve
from Game inner join Game_invitation on Game.game_id=Game_invitation.game_id
